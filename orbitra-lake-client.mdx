...
``None`` (the default) is left untouched, ``""`` clears it and any other value sets it.
...
updated_table = client.create_or_update_table(
    ...
    table=TableSchema(
        ...
        columns=[
            ColumnSchema(name="column1", type="string", kind="regular", description="The first column"),
...
table_schema = TableSchema(
        ...
        description="Example table",
        columns=[
            ColumnSchema(name="id", type="int", kind="regular", description="Unique row id"),
